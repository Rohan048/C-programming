// Program No. 7 Write a menu-driven program to implement the following operations on the singly linked list:
...
void main(){
    ...
    while(1){
        ...
        switch(ch){
            ...
            case 9: delete_before_position();    break;
            case 10: delete_all_ocurrence();    break;
            case 11: exit(0);
